...
export default function Page() {
  ...
  return (
    <CaseStudyPageTemplate
      contactHref="/contact?cta=case-study-discussion&page_type=case-study&inquiry_type=portfolio&interest=healthcare&source_slug=novo-nordisk-sample-ordering-application"
      discussionHref="/contact?cta=case-study-discussion&page_type=case-study&inquiry_type=portfolio&interest=healthcare&source_slug=novo-nordisk-sample-ordering-application"

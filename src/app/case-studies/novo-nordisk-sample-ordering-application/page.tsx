...
export const metadata: Metadata = {
  title: 'Nova Nordisk Sample Ordering App | Logic Unit',
  ...
  alternates: {
    canonical: '/case-studies/nova-nordisk-sample-ordering-application',
  },
};
...
export default function Page() {
  const schemaJson = {
    ...
    '@type': 'Article',
    'headline': 'Nova Nordisk Healthcare Professional Sample Ordering Application Case Study',
    'description': 'Logic Unit built a secure iOS sample ordering app for healthcare professionals with compliance and education workflows.',
    'publisher': {
      '@type': 'Organization',
      'name': 'Logic Unit',

...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/ecosystem/titan-mms`, lastModified, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/ecosystem/animalcare360`, lastModified, changeFrequency: 'monthly', priority: 0.7 },
